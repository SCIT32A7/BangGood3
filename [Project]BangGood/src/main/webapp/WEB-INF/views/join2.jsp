		...
		<div class="modal-body row space-xlg-hor equal-height-columns">
			<div class="form-block reg-block col-md-12 col-sm-8 joinbox" style="background-color:#fff">
				...
				<div class="input-group margin-bottom-20">
					...
					<button id="idCheck"  class="btn-u btn-block rounded" style="background-color:#f7be22; width:80px">
							중복확인
					</button>					
				</div>
				...
				<div class="input-group margin-bottom-20">
					...
					<input type="mail" name = "email" id = "joinemail" class="form-control rounded-right" placeholder="이메일 주소를 입력해 주세요.">
				</div>
				<div class="input-group margin-bottom-20">
